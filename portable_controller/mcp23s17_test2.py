...
# LED
mcp_U2.setDirection(8, mcp_U2.DIR_OUTPUT)
#  SWITCH
...
while True:
    ...
    # if mcp_U3.digitalRead(11) == MCP23S17.LEVEL_LOW:
    #     mcp_U2.digitalWrite(8, MCP23S17.LEVEL_LOW)
    # else:
    #     mcp_U2.digitalWrite(8, MCP23S17.LEVEL_HIGH)
    mcp_U2.digitalWrite(8, MCP23S17.LEVEL_LOW)
    time.sleep(1)
    mcp_U2.digitalWrite(8, MCP23S17.LEVEL_HIGH)
    time.sleep(1)
